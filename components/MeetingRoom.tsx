...
const MeetingRoom = () => {
  ...
  // !!searchParams becoz we have to convert string type value to boolean type value
  // if 'personal'=>!'personal'=>false=>!false=>true
  // if undefined => ! undefined => true => !true => false
